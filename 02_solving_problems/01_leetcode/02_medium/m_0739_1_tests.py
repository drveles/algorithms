...
class TestSolution(unittest.TestCase):
    def test_dailyTemperatures(self):
        ...
        self.assertEqual(
            solution.dailyTemperatures([50, 50, 50, 50, 50]), [0, 0, 0, 0, 0]
        )

        # Тест на входной список, где температуры убывают
        self.assertEqual(
            solution.dailyTemperatures([50, 40, 30, 20, 10]), [0, 0, 0, 0, 0]
        )

        # Тест на входной список, где температуры возрастают
        self.assertEqual(
            solution.dailyTemperatures([10, 20, 30, 40, 50]), [1, 1, 1, 1, 0]
        )

        self.assertEqual(
            solution.dailyTemperatures([30, 20, 30, 40, 50]), [3, 1, 1, 1, 0]
        )
